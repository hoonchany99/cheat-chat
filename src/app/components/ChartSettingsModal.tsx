  ...
  return (
    ...
    >
      ...
      <Button
        ...
        size="sm"
        className={`h-6 text-xs px-2 ${field.required ? 'bg-blue-600 hover:bg-blue-700' : ''}`}
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                {DEPARTMENT_PRESETS.map(preset => (
                  ...
                  >
                    ...
                    <span className={`text-xs ${localSettings.selectedDepartment === preset.id ? 'text-blue-100' : 'opacity-70'}`}>
            ...
            <TabsContent value="fields" className="mt-0 space-y-4 pr-3">
              ...
              <div className="border-t pt-4">
                ...
                <div className="flex gap-2">
                  ...
                  <Button onClick={handleAddField} disabled={!newFieldName.trim()} className="bg-blue-600 hover:bg-blue-700">
